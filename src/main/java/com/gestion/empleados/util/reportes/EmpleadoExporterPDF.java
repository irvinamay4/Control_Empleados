...
public class EmpleadoExporterPDF {
	...
	//Crea los datos de la cabecera en el documento
	...
	//Trae los datos de la bd paara ponerlos en el documento
	...
	public void exportar(HttpServletResponse response) throws DocumentException, IOException {
		...
		tabla.setWidths(new float[] {1f, 2.3f, 2.3f, 6f, 2.9f, 3.5f,2f,2.2f}); //1-ancho de columna del id 2-del nombre, 3-del apellido ... 7-del salario
